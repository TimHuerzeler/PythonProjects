class PhoneKeyboard:
    ...
    def __init__(self):
        ...
        This method is automatically invoked when a new object is intanciated
        """
...
def main():
    ...
    phone.backspace()
    phone.press('3')
    phone.press('2'); phone.press('3')
    phone.press('2'); phone.press('1'); phone.press('6')
    phone.press('3'); phone.press('2'); phone.press('4')
    phone.dial()
